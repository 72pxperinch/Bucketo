...
class _CategoryState extends State<Category> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Your ${widget.cat} List'),
      ),
      body: FutureBuilder(
  ...
  Future<List<Map<String, dynamic>>> fetchDataFromFirestore() async {
    ...
    // Filter data based on the specified category ('cat') and user email
    dataList = dataList
        .where((data) =>
            data['category'] == widget.cat && data['user'] == currentUserEmail)
        .toList();

    // Sort the filtered dataList based on the 'date' field
